...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(productService, loginService) {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.loginService.getUserState().subscribe(function (data) {
            _this.logged = data;
        });
    };
...
var NavbarComponent = /** @class */ (function () {
    function NavbarComponent(loginService, router, afsAuth) {
        this.loginService = loginService;
        this.router = router;
    ...
    NavbarComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.afsAuth.authState.subscribe(function (res) {
            _this.authValue = res;
        });
    };
...
var ProductComponent = /** @class */ (function () {
    ...
    ProductComponent.prototype.ngOnInit = function () {
        ...
        this.productService.getProduct(this.id).subscribe(function (res) {
            _this.name = res.name;
            _this.sku = res.partNumber;
            _this.precioNormal = res.prices.listPrice;
            _this.precioOferta = res.prices.offerPrice;
            _this.descuento = res.prices.discountPercentage;
            _this.ripleyPts = res.prices.ripleyPuntos;
            _this.photo = res.thumbnailImage;
            _this.descripcion = res.longDescription;
        });
    };
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent.prototype.crearUsuario = function (form) {
...
var AuthGuard = /** @class */ (function () {
    function AuthGuard(loginService, router, afsAuth) {
        this.loginService = loginService;
        this.router = router;
        this.afsAuth = afsAuth;
    }
    AuthGuard.prototype.canActivate = function (next, state) {
        ...
        return this.afsAuth.authState
            ...
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["map"])(function (authState) { return !!authState; }))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (auth) {
            if (!auth) {
...
var LoginService = /** @class */ (function () {
    ...
    LoginService.prototype.crearUser = function (user) {
        var _this = this;
        this.afAuth.auth.createUserWithEmailAndPassword(user.email, user.password).then(function (userCred) {
            _this.userNuevo = user;
            userCred.user.updateProfile({
                displayName: user.firstName + ' ' + user.lastName
            });
            _this.addData(userCred).then(function () {
    ...
    ;
    LoginService.prototype.addData = function (userCred) {
